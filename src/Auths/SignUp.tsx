    ...
    <div className="flex overflow-y-auto h-screen bg-white">
      ...
      <div className="flex items-center w-[50vw] mb-[60px]">
        <div>
          ...
          <div className="mt-7 md:mt-5 ml-[2vw] md:ml-9 flex items-center justify-center w-[96vw] md:w-[504px] h-[504px] flex-shrink-0 rounded-none md:rounded-2xl bg-white shadow-none md:shadow-form-bx-sh">
